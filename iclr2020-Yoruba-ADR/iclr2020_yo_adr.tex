...
% \end{itemize}
 ...
 \begin{table}[h]
  ...
  \begin{tabular}{rll}
    ...
    177,675 & GitHub & Yor{\`u}b{\'a}Twi embeddings dataset \\
...
The authors are grateful for all the support received from Yor{\`u}b{\'a} Name, Masakhane and DataScience Nigeria. 
...
\begin{table}[h]
\caption{Example Yor{\`u}b{\'a} ADR Sentences}
\label{results}
\begin{center}
  \begin{tabular}{ll}
  	\toprule \\
